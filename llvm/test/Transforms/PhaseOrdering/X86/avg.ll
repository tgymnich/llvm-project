...
; AVX2-NEXT:    [[ADD_1:%.*]] = add nuw nsw i16 [[TMP1]], 1
; AVX2-NEXT:    [[ADD5_1:%.*]] = add nuw nsw i16 [[ADD_1]], [[TMP5]]
...
; AVX2-NEXT:    [[ADD_9:%.*]] = add nuw nsw i16 [[TMP3]], 1
; AVX2-NEXT:    [[ADD5_9:%.*]] = add nuw nsw i16 [[ADD_9]], [[TMP7]]
; AVX2-NEXT:    [[TMP14:%.*]] = shl nuw i16 [[ADD5_1]], 7
; AVX2-NEXT:    [[TMP17:%.*]] = and i16 [[TMP14]], -256
...
; AVX2-NEXT:    [[RETVAL_SROA_2_0_INSERT_SHIFT_MASKED:%.*]] = zext i16 [[TMP17]] to i64
...
; AVX2-NEXT:    [[TMP15:%.*]] = insertelement <8 x i64> [[TMP12]], i64 [[RETVAL_SROA_2_0_INSERT_SHIFT_MASKED]], i64 2
; AVX2-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i64> [[TMP15]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 2>
...
; AVX2-NEXT:    [[TMP48:%.*]] = shl nuw i16 [[ADD5_9]], 7
; AVX2-NEXT:    [[TMP49:%.*]] = and i16 [[TMP48]], -256
; AVX2-NEXT:    [[TMP50:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE1]], i64 0
; AVX2-NEXT:    [[TMP51:%.*]] = shufflevector <8 x i64> [[TMP50]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX2-NEXT:    [[TMP16:%.*]] = lshr <8 x i64> [[TMP51]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX2-NEXT:    [[RETVAL_SROA_11_8_INSERT_SHIFT_MASKED:%.*]] = zext i16 [[TMP49]] to i64
...
; AVX2-NEXT:    [[TMP52:%.*]] = insertelement <8 x i64> [[TMP34]], i64 [[RETVAL_SROA_11_8_INSERT_SHIFT_MASKED]], i64 2
; AVX2-NEXT:    [[TMP35:%.*]] = shufflevector <8 x i64> [[TMP52]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 2>
...
; AVX512-NEXT:    [[ADD_1:%.*]] = add nuw nsw i16 [[TMP1]], 1
; AVX512-NEXT:    [[ADD5_1:%.*]] = add nuw nsw i16 [[ADD_1]], [[TMP5]]
...
; AVX512-NEXT:    [[ADD_9:%.*]] = add nuw nsw i16 [[TMP3]], 1
; AVX512-NEXT:    [[ADD5_9:%.*]] = add nuw nsw i16 [[ADD_9]], [[TMP7]]
; AVX512-NEXT:    [[TMP14:%.*]] = shl nuw i16 [[ADD5_1]], 7
; AVX512-NEXT:    [[TMP17:%.*]] = and i16 [[TMP14]], -256
...
; AVX512-NEXT:    [[RETVAL_SROA_2_0_INSERT_SHIFT_MASKED:%.*]] = zext i16 [[TMP17]] to i64
...
; AVX512-NEXT:    [[TMP15:%.*]] = insertelement <8 x i64> [[TMP12]], i64 [[RETVAL_SROA_2_0_INSERT_SHIFT_MASKED]], i64 2
; AVX512-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i64> [[TMP15]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 2>
...
; AVX512-NEXT:    [[TMP48:%.*]] = shl nuw i16 [[ADD5_9]], 7
; AVX512-NEXT:    [[TMP49:%.*]] = and i16 [[TMP48]], -256
; AVX512-NEXT:    [[TMP50:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE1]], i64 0
; AVX512-NEXT:    [[TMP51:%.*]] = shufflevector <8 x i64> [[TMP50]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX512-NEXT:    [[TMP16:%.*]] = lshr <8 x i64> [[TMP51]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX512-NEXT:    [[RETVAL_SROA_11_8_INSERT_SHIFT_MASKED:%.*]] = zext i16 [[TMP49]] to i64
...
; AVX512-NEXT:    [[TMP52:%.*]] = insertelement <8 x i64> [[TMP34]], i64 [[RETVAL_SROA_11_8_INSERT_SHIFT_MASKED]], i64 2
; AVX512-NEXT:    [[TMP35:%.*]] = shufflevector <8 x i64> [[TMP52]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 2>
...
; SSE2-NEXT:    [[SHR_3:%.*]] = lshr i16 [[B_SROA_0_0_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[SHR_2:%.*]] = lshr i16 [[B_SROA_2_0_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[SHR5_3:%.*]] = lshr i16 [[B_SROA_4_0_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[SHR5_2:%.*]] = lshr i16 [[B_SROA_3_0_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[B_SROA_9_8_EXTRACT_TRUNC:%.*]] = add nuw i16 [[SHR5_3]], [[SHR_3]]
...
; SSE2-NEXT:    [[TMP48:%.*]] = shufflevector <2 x i16> [[TMP10]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE2-NEXT:    [[TMP53:%.*]] = insertelement <4 x i16> [[TMP48]], i16 [[NARROW_2]], i64 2
; SSE2-NEXT:    [[TMP54:%.*]] = insertelement <4 x i16> [[TMP53]], i16 [[B_SROA_9_8_EXTRACT_TRUNC]], i64 3
; SSE2-NEXT:    [[TMP15:%.*]] = add nuw <4 x i16> [[TMP54]], [[TMP9]]
...
; SSE2-NEXT:    [[B_SROA_8_8_EXTRACT_TRUNC1:%.*]] = trunc i64 [[B_SROA_8_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[SHR_7:%.*]] = lshr i16 [[A_SROA_5_8_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[SHR_6:%.*]] = lshr i16 [[NARROW]], 1
; SSE2-NEXT:    [[SHR5_7:%.*]] = lshr i16 [[B_SROA_8_8_EXTRACT_TRUNC]], 1
; SSE2-NEXT:    [[SHR5_6:%.*]] = lshr i16 [[B_SROA_8_8_EXTRACT_TRUNC1]], 1
...
; SSE2-NEXT:    [[TMP36:%.*]] = insertelement <4 x i16> [[TMP35]], i16 [[B_SROA_8_8_EXTRACT_TRUNC1]], i64 2
...
; SSE2-NEXT:    [[TMP30:%.*]] = insertelement <4 x i16> [[TMP44]], i16 [[NARROW_7]], i64 3
