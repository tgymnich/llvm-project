...
; CHECK-CACHE-NEXT:    [[MUL_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
; CHECK-CACHE-NEXT:    [[MUL_CACHE:%.*]] = load double, ptr [[MUL_CACHEIDX4]], align 8
...
; CHECK-RECOMPUTE-NEXT:    [[VAL2_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 0
; CHECK-RECOMPUTE-NEXT:    [[VAL2_CACHE:%.*]] = load double, ptr [[VAL2_CACHEIDX3]], align 8
; CHECK-RECOMPUTE-NEXT:    [[VAL1_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
; CHECK-RECOMPUTE-NEXT:    [[VAL1_CACHE:%.*]] = load double, ptr [[VAL1_CACHEIDX4]], align 8
...
; CHECK-MINCUT-NEXT:    [[MUL_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
; CHECK-MINCUT-NEXT:    [[MUL_CACHE:%.*]] = load double, ptr [[MUL_CACHEIDX4]], align 8
