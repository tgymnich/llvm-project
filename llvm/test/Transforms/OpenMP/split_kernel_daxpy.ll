...
; CHECK-NEXT:    [[I18:%.*]] = tail call noundef i32 @llvm.nvvm.read.ptx.sreg.tid.x() #[[ATTR5:[0-9]+]]
; CHECK-NEXT:    [[I4:%.*]] = tail call i32 @llvm.nvvm.read.ptx.sreg.nctaid.x() #[[ATTR4]], !range [[RNG17:![0-9]+]]
; CHECK-NEXT:    [[I:%.*]] = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() #[[ATTR6:[0-9]+]], !range [[RNG18:![0-9]+]]
...
; CHECK:       bb11:
; CHECK-NEXT:    [[I743:%.*]] = phi i32 [ [[I743]], [[BB41:%.*]] ], [ [[I7]], [[BB]] ]
; CHECK-NEXT:    [[I2541:%.*]] = phi i32 [ [[I2541]], [[BB41]] ], [ [[I25]], [[BB]] ]
; CHECK-NEXT:    [[I434:%.*]] = phi i32 [ [[I434]], [[BB41]] ], [ [[I4]], [[BB]] ]
; CHECK-NEXT:    [[I1831:%.*]] = phi i32 [ [[I1831]], [[BB41]] ], [ [[I18]], [[BB]] ]
; CHECK-NEXT:    [[I28:%.*]] = phi i32 [ [[I28]], [[BB41]] ], [ [[I]], [[BB]] ]
...
; CHECK-NEXT:    [[I_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 0
; CHECK-NEXT:    store i32 [[I28]], ptr [[I_CACHEIDX]], align 4
; CHECK-NEXT:    [[I18_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 1
; CHECK-NEXT:    store i32 [[I1831]], ptr [[I18_CACHEIDX]], align 4
; CHECK-NEXT:    [[I4_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 2
; CHECK-NEXT:    store i32 [[I434]], ptr [[I4_CACHEIDX]], align 4
; CHECK-NEXT:    [[I13_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 3
; CHECK-NEXT:    store i32 [[I13]], ptr [[I13_CACHEIDX]], align 4
; CHECK-NEXT:    [[I12_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 4
; CHECK-NEXT:    store i32 [[I12]], ptr [[I12_CACHEIDX]], align 4
; CHECK-NEXT:    [[I32_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 5
; CHECK-NEXT:    store i32 [[I24]], ptr [[I32_CACHEIDX]], align 4
; CHECK-NEXT:    [[I25_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 6
; CHECK-NEXT:    store i32 [[I2541]], ptr [[I25_CACHEIDX]], align 4
; CHECK-NEXT:    [[I31_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 7
...
; CHECK-NEXT:    [[I42]] = add nsw i32 [[I13]], [[I743]]
; CHECK-NEXT:    [[I43:%.*]] = add nsw i32 [[I12]], [[I743]]
...
; CHECK-NEXT:    [[I21:%.*]] = ptrtoint ptr [[I17]] to i64
; CHECK-NEXT:    [[I22:%.*]] = trunc i64 [[I20]] to i32
; CHECK-NEXT:    [[I24:%.*]] = add nsw i32 [[I1829]], [[I22]]
; CHECK-NEXT:    [[I26:%.*]] = sext i32 [[I24]] to i64
; CHECK-NEXT:    [[I27:%.*]] = icmp ugt i64 [[I26]], [[I21]]
; CHECK-NEXT:    br i1 [[I27]], label [[BB41:%.*]], label [[BB28:%.*]]
; CHECK:       bb28:
...
; CHECK:       CacheStore:
; CHECK-NEXT:    [[I2540:%.*]] = phi i32 [ [[I2539:%.*]], [[BB28]] ], [ [[I25_CACHE:%.*]], [[CACHEREMAT]] ]
; CHECK-NEXT:    [[I1238:%.*]] = phi i32 [ [[I44]], [[BB28]] ], [ [[I12_CACHE:%.*]], [[CACHEREMAT]] ]
; CHECK-NEXT:    [[I1336:%.*]] = phi i32 [ [[I42]], [[BB28]] ], [ [[I13_CACHE:%.*]], [[CACHEREMAT]] ]
; CHECK-NEXT:    [[I433:%.*]] = phi i32 [ [[I432:%.*]], [[BB28]] ], [ [[I4_CACHE:%.*]], [[CACHEREMAT]] ]
; CHECK-NEXT:    [[I1830:%.*]] = phi i32 [ [[I1829]], [[BB28]] ], [ [[I18_CACHE:%.*]], [[CACHEREMAT]] ]
; CHECK-NEXT:    [[I23:%.*]] = phi i32 [ [[I11:%.*]], [[BB28]] ], [ [[I_CACHE:%.*]], [[CACHEREMAT]] ]
...
; CHECK-NEXT:    [[CACHECELL:%.*]] = getelementptr inbounds [[CACHE_CELL:%.*]], ptr [[CACHE_OUT_PTR]], i32 [[CACHEIDX]]
; CHECK-NEXT:    [[I_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 0
; CHECK-NEXT:    store i32 [[I23]], ptr [[I_CACHEIDX]], align 4
; CHECK-NEXT:    [[I18_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 1
; CHECK-NEXT:    store i32 [[I1830]], ptr [[I18_CACHEIDX]], align 4
; CHECK-NEXT:    [[I4_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 2
; CHECK-NEXT:    store i32 [[I433]], ptr [[I4_CACHEIDX]], align 4
; CHECK-NEXT:    [[I13_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 3
; CHECK-NEXT:    store i32 [[I1336]], ptr [[I13_CACHEIDX]], align 4
; CHECK-NEXT:    [[I12_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 4
; CHECK-NEXT:    store i32 [[I1238]], ptr [[I12_CACHEIDX]], align 4
; CHECK-NEXT:    [[I32_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 5
; CHECK-NEXT:    store i32 [[I32]], ptr [[I32_CACHEIDX]], align 4
; CHECK-NEXT:    [[I25_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 6
; CHECK-NEXT:    store i32 [[I2540]], ptr [[I25_CACHEIDX]], align 4
; CHECK-NEXT:    [[I31_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL]], i32 0, i32 7
...
; CHECK-NEXT:    [[I_CACHEIDX2:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 0
; CHECK-NEXT:    [[I_CACHE]] = load i32, ptr [[I_CACHEIDX2]], align 4
; CHECK-NEXT:    [[I18_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 1
; CHECK-NEXT:    [[I18_CACHE]] = load i32, ptr [[I18_CACHEIDX3]], align 4
; CHECK-NEXT:    [[I4_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 2
; CHECK-NEXT:    [[I4_CACHE]] = load i32, ptr [[I4_CACHEIDX4]], align 4
; CHECK-NEXT:    [[I13_CACHEIDX5:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 3
; CHECK-NEXT:    [[I13_CACHE]] = load i32, ptr [[I13_CACHEIDX5]], align 4
; CHECK-NEXT:    [[I12_CACHEIDX6:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 4
; CHECK-NEXT:    [[I12_CACHE]] = load i32, ptr [[I12_CACHEIDX6]], align 4
; CHECK-NEXT:    [[I32_CACHEIDX7:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 5
; CHECK-NEXT:    [[I32_CACHE:%.*]] = load i32, ptr [[I32_CACHEIDX7]], align 4
; CHECK-NEXT:    [[I25_CACHEIDX8:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 6
; CHECK-NEXT:    [[I25_CACHE]] = load i32, ptr [[I25_CACHEIDX8]], align 4
; CHECK-NEXT:    [[I31_CACHEIDX9:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 7
; CHECK-NEXT:    [[I31_CACHE:%.*]] = load i64, ptr [[I31_CACHEIDX9]], align 8
...
; CHECK-NEXT:    [[I24_RECOMPUTE:%.*]] = add nsw i32 [[I18_CACHE]], [[I22_RECOMPUTE]]
...
; CHECK:       bb41:
; CHECK-NEXT:    [[I742:%.*]] = phi i32 [ [[I7_RECOMPUTE]], [[CACHEREMAT]] ], [ [[I742]], [[BB11:%.*]] ]
; CHECK-NEXT:    [[I2539]] = phi i32 [ [[I25_CACHE]], [[CACHEREMAT]] ], [ [[I2539]], [[BB11]] ]
; CHECK-NEXT:    [[I1237:%.*]] = phi i32 [ [[I12_CACHE]], [[CACHEREMAT]] ], [ [[I44]], [[BB11]] ]
; CHECK-NEXT:    [[I1335:%.*]] = phi i32 [ [[I13_CACHE]], [[CACHEREMAT]] ], [ [[I42]], [[BB11]] ]
; CHECK-NEXT:    [[I432]] = phi i32 [ [[I4_CACHE]], [[CACHEREMAT]] ], [ [[I432]], [[BB11]] ]
; CHECK-NEXT:    [[I1829]] = phi i32 [ [[I18_CACHE]], [[CACHEREMAT]] ], [ [[I1829]], [[BB11]] ]
; CHECK-NEXT:    [[I11]] = phi i32 [ [[I_CACHE]], [[CACHEREMAT]] ], [ [[I11]], [[BB11]] ]
; CHECK-NEXT:    tail call void @llvm.nvvm.barrier0() #[[ATTR7]]
; CHECK-NEXT:    [[I42]] = add nsw i32 [[I1335]], [[I742]]
; CHECK-NEXT:    [[I43:%.*]] = add nsw i32 [[I1237]], [[I742]]
; CHECK-NEXT:    [[I44]] = tail call i32 @llvm.smin.i32(i32 [[I43]], i32 1023)
; CHECK-NEXT:    [[I45:%.*]] = icmp slt i32 [[I42]], 1024
; CHECK-NEXT:    br i1 [[I45]], label [[BB11]], label [[BB46:%.*]]
; CHECK:       bb46:
