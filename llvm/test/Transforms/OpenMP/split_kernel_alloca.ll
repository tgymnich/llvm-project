...
; CHECK-NEXT:   %contcnt = getelementptr inbounds %struct.KernelLaunchEnvironmentTy.0, ptr %launch_env, i32 0, i32 3
; CHECK-NEXT:   %cacheidx = atomicrmw add ptr %contcnt, i32 1 acquire, align 4
; CHECK-NEXT:   %ptry.cacheidx = getelementptr inbounds [32 x %cache_cell], ptr @test_cont_cache, i32 %cacheidx, i64 0
