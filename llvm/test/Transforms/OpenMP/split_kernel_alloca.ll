...
; CHECK-NEXT:    [[PTRY:%.*]] = alloca double, align 8
; CHECK-NEXT:    [[IDXY:%.*]] = getelementptr inbounds double, ptr [[PTR]], i64 9
; CHECK-NEXT:    [[VALY:%.*]] = load double, ptr [[IDXY]], align 8
; CHECK-NEXT:    store double [[VALY]], ptr [[PTRY]], align 8
...
; CHECK-NEXT:    [[PTRY_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL1]], i32 0, i32 0
; CHECK-NEXT:    [[TMP5:%.*]] = load double, ptr [[PTRY]], align 8
; CHECK-NEXT:    store double [[TMP5]], ptr [[PTRY_CACHEIDX]], align 8
...
; CHECK-NEXT:    [[CACHECELL2:%.*]] = getelementptr inbounds [[CACHE_CELL:%.*]], ptr [[CACHE_IN_PTR]], i32 [[GTID]]
; CHECK-NEXT:    [[ARRAYIDX_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL2]], i32 0, i32 0
...
; CHECK-NEXT:    [[PTRY_CACHEIDX5:%.*]] = getelementptr inbounds [[CACHE_CELL]], ptr [[CACHECELL4]], i32 0, i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = load double, ptr [[PTRY_CACHEIDX5]], align 8
