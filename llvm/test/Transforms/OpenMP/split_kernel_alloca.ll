...
; CHECK-NEXT:    [[PTRY_CACHEIDX:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL]], i32 0, i32 1
; CHECK-NEXT:    [[TMP5:%.*]] = load double, ptr [[PTRY]], align 8
; CHECK-NEXT:    store double [[TMP5]], ptr [[PTRY_CACHEIDX]], align 8, !invariant.group [[META4:![0-9]+]]
...
; CHECK-NEXT:    [[PTRY_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL1]], i32 0, i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = load double, ptr [[PTRY_CACHEIDX3]], align 8, !invariant.group [[META3]]
