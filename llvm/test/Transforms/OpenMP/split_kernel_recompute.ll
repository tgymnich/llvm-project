...
; CHECK-CACHE-NEXT:    [[ARRAYIDX_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 0
; CHECK-CACHE-NEXT:    [[ARRAYIDX_CACHE:%.*]] = load ptr, ptr [[ARRAYIDX_CACHEIDX3]], align 8
; CHECK-CACHE-NEXT:    [[VAL_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
; CHECK-CACHE-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[VAL_CACHEIDX4]], align 8
; CHECK-CACHE-NEXT:    [[SUB_CACHEIDX5:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 2
; CHECK-CACHE-NEXT:    [[SUB_CACHE:%.*]] = load double, ptr [[SUB_CACHEIDX5]], align 8
; CHECK-CACHE-NEXT:    [[ADD_CACHEIDX6:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 3
...
; CHECK-CACHE-NEXT:    [[DIV_CACHEIDX8:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 5
; CHECK-CACHE-NEXT:    [[DIV_CACHE:%.*]] = load double, ptr [[DIV_CACHEIDX8]], align 8
...
; CHECK-RECOMPUTE-NEXT:    [[VAL_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 0
; CHECK-RECOMPUTE-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[VAL_CACHEIDX3]], align 8
; CHECK-RECOMPUTE-NEXT:    [[TID_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
...
; CHECK-MINCUT-NEXT:    [[ARRAYIDX_CACHEIDX3:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 0
; CHECK-MINCUT-NEXT:    [[ARRAYIDX_CACHE:%.*]] = load ptr, ptr [[ARRAYIDX_CACHEIDX3]], align 8
; CHECK-MINCUT-NEXT:    [[VAL_CACHEIDX4:%.*]] = getelementptr inbounds [[CACHE_CELL0]], ptr [[CACHECELL2]], i32 0, i32 1
; CHECK-MINCUT-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[VAL_CACHEIDX4]], align 8
