...
; CHECK-CACHE-NEXT:    store ptr [[ARRAYIDX]], ptr [[TMP6]], align 8, !invariant.group [[META3:![0-9]+]]
; CHECK-CACHE-NEXT:    [[TMP7:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP8:%.*]] = getelementptr inbounds double, ptr [[TMP7]], i32 [[CACHEIDX]]
; CHECK-CACHE-NEXT:    store double [[VAL]], ptr [[TMP8]], align 8, !invariant.group [[META4:![0-9]+]]
; CHECK-CACHE-NEXT:    [[TMP9:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP10:%.*]] = getelementptr inbounds double, ptr [[TMP9]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP11:%.*]] = getelementptr inbounds double, ptr [[TMP10]], i32 [[CACHEIDX]]
; CHECK-CACHE-NEXT:    store double [[SUB]], ptr [[TMP11]], align 8, !invariant.group [[META5:![0-9]+]]
; CHECK-CACHE-NEXT:    [[TMP12:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP13:%.*]] = getelementptr inbounds double, ptr [[TMP12]], i32 [[CACHE_OUT_OFFSET]]
...
; CHECK-CACHE-NEXT:    store double [[ADD]], ptr [[TMP15]], align 8, !invariant.group [[META6:![0-9]+]]
; CHECK-CACHE-NEXT:    [[TMP16:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP17:%.*]] = getelementptr inbounds double, ptr [[TMP16]], i32 [[CACHE_OUT_OFFSET]]
...
; CHECK-CACHE-NEXT:    [[TMP21:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP22:%.*]] = getelementptr inbounds double, ptr [[TMP21]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP23:%.*]] = getelementptr inbounds double, ptr [[TMP22]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP24:%.*]] = getelementptr inbounds double, ptr [[TMP23]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP25:%.*]] = getelementptr inbounds double, ptr [[TMP24]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP26:%.*]] = getelementptr inbounds double, ptr [[TMP25]], i32 [[CACHEIDX]]
; CHECK-CACHE-NEXT:    store double [[DIV]], ptr [[TMP26]], align 8, !invariant.group [[META8:![0-9]+]]
...
; CHECK-CACHE-NEXT:    [[ARRAYIDX_CACHE:%.*]] = load ptr, ptr [[TMP10]], align 8, !invariant.group [[META3]]
; CHECK-CACHE-NEXT:    [[TMP11:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP12:%.*]] = getelementptr inbounds double, ptr [[TMP11]], i32 [[GTID]]
; CHECK-CACHE-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[TMP12]], align 8, !invariant.group [[META4]]
; CHECK-CACHE-NEXT:    [[TMP13:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP14:%.*]] = getelementptr inbounds double, ptr [[TMP13]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP15:%.*]] = getelementptr inbounds double, ptr [[TMP14]], i32 [[GTID]]
; CHECK-CACHE-NEXT:    [[SUB_CACHE:%.*]] = load double, ptr [[TMP15]], align 8, !invariant.group [[META5]]
; CHECK-CACHE-NEXT:    [[TMP16:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP17:%.*]] = getelementptr inbounds double, ptr [[TMP16]], i32 [[CACHE_IN_OFFSET]]
...
; CHECK-CACHE-NEXT:    [[ADD_CACHE:%.*]] = load double, ptr [[TMP19]], align 8, !invariant.group [[META6]]
; CHECK-CACHE-NEXT:    [[TMP20:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP21:%.*]] = getelementptr inbounds double, ptr [[TMP20]], i32 [[CACHE_IN_OFFSET]]
...
; CHECK-CACHE-NEXT:    [[TMP25:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP26:%.*]] = getelementptr inbounds double, ptr [[TMP25]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP27:%.*]] = getelementptr inbounds double, ptr [[TMP26]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP28:%.*]] = getelementptr inbounds double, ptr [[TMP27]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP29:%.*]] = getelementptr inbounds double, ptr [[TMP28]], i32 [[CACHE_IN_OFFSET]]
; CHECK-CACHE-NEXT:    [[TMP30:%.*]] = getelementptr inbounds double, ptr [[TMP29]], i32 [[GTID]]
; CHECK-CACHE-NEXT:    [[DIV_CACHE:%.*]] = load double, ptr [[TMP30]], align 8, !invariant.group [[META8]]
...
; CHECK-RECOMPUTE-NEXT:    store double [[VAL]], ptr [[TMP6]], align 8, !invariant.group [[META3:![0-9]+]]
; CHECK-RECOMPUTE-NEXT:    [[TMP7:%.*]] = getelementptr inbounds double, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-RECOMPUTE-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i64, ptr [[TMP7]], i32 [[CACHEIDX]]
; CHECK-RECOMPUTE-NEXT:    store i64 [[TID]], ptr [[TMP8]], align 8, !invariant.group [[META4:![0-9]+]]
...
; CHECK-RECOMPUTE-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[TMP10]], align 8, !invariant.group [[META3]]
; CHECK-RECOMPUTE-NEXT:    [[TMP11:%.*]] = getelementptr inbounds double, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-RECOMPUTE-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i64, ptr [[TMP11]], i32 [[GTID]]
; CHECK-RECOMPUTE-NEXT:    [[TID_CACHE:%.*]] = load i64, ptr [[TMP12]], align 8, !invariant.group [[META4]]
...
; CHECK-MINCUT-NEXT:    store ptr [[ARRAYIDX]], ptr [[TMP6]], align 8, !invariant.group [[META3:![0-9]+]]
; CHECK-MINCUT-NEXT:    [[TMP7:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_OUT_PTR]], i32 [[CACHE_OUT_OFFSET]]
; CHECK-MINCUT-NEXT:    [[TMP8:%.*]] = getelementptr inbounds double, ptr [[TMP7]], i32 [[CACHEIDX]]
; CHECK-MINCUT-NEXT:    store double [[VAL]], ptr [[TMP8]], align 8, !invariant.group [[META4:![0-9]+]]
...
; CHECK-MINCUT-NEXT:    [[ARRAYIDX_CACHE:%.*]] = load ptr, ptr [[TMP10]], align 8, !invariant.group [[META3]]
; CHECK-MINCUT-NEXT:    [[TMP11:%.*]] = getelementptr inbounds ptr, ptr [[CACHE_IN_PTR]], i32 [[CACHE_IN_OFFSET]]
; CHECK-MINCUT-NEXT:    [[TMP12:%.*]] = getelementptr inbounds double, ptr [[TMP11]], i32 [[GTID]]
; CHECK-MINCUT-NEXT:    [[VAL_CACHE:%.*]] = load double, ptr [[TMP12]], align 8, !invariant.group [[META4]]
