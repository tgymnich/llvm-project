...
; RUN: llc -mtriple=amdgpu6.00 -stop-after=amdgpu-isel < %s | FileCheck -enable-var-scope -check-prefixes=GCN-ISEL                %s
; RUN: llc -mtriple=amdgpu6.00 -stop-after=amdgpu-isel -enable-new-pm < %s | FileCheck -enable-var-scope -check-prefixes=GCN-ISEL                %s

; RUN: llc -mtriple=amdgpu6.01   < %s | FileCheck -enable-var-scope -check-prefixes=CISI    %s
; RUN: llc -mtriple=amdgpu8.03    < %s | FileCheck -enable-var-scope -check-prefixes=VI      %s
; RUN: llc -mtriple=amdgpu9.00  < %s | FileCheck -enable-var-scope -check-prefixes=GFX9    %s
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1010 %s
; RUN: llc -mtriple=amdgpu10.30 -mattr=+wavefrontsize32 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1030W32 %s
; RUN: llc -mtriple=amdgpu10.30 -mattr=+wavefrontsize64 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1030W64 %s
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11 %s
; RUN: llc -mtriple=amdgpu12.50 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250 %s
; RUN: llc -mtriple=amdgpu13.10 < %s | FileCheck -enable-var-scope -check-prefixes=GFX13 %s
...
; CISI-NEXT:    s_and_b64 s[4:5], vcc, exec
; CISI-NEXT:    s_cselect_b32 s4, 1, 0
...
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_add_co_u32 v0, s4, s6, s7
; GFX1010-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX1010-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1010-NEXT:    v_mov_b32_e32 v2, s4
; GFX1010-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX1010-NEXT:    global_store_byte v1, v2, s[2:3]
; GFX1010-NEXT:    s_endpgm
;
...
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030W32-NEXT:    v_add_co_u32 v0, s4, s6, s7
; GFX1030W32-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX1030W32-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1030W32-NEXT:    v_mov_b32_e32 v2, s4
; GFX1030W32-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX1030W32-NEXT:    global_store_byte v1, v2, s[2:3]
; GFX1030W32-NEXT:    s_endpgm
;
...
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030W64-NEXT:    v_add_co_u32 v0, s[4:5], s6, s7
; GFX1030W64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1030W64-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1030W64-NEXT:    v_mov_b32_e32 v2, s4
; GFX1030W64-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX1030W64-NEXT:    global_store_byte v1, v2, s[2:3]
; GFX1030W64-NEXT:    s_endpgm
;
...
; GFX13-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_add_co_u32 v0, s4, s6, s7
; GFX13-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX13-NEXT:    s_cselect_b32 s4, 1, 0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, s4
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX13-NEXT:    global_store_b8 v1, v2, s[2:3]
; GFX13-NEXT:    s_endpgm
...
; CISI-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX9-NEXT:    s_addc_u32 s2, s13, s15
...
; GFX1010-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1010-NEXT:    v_mov_b32_e32 v0, s0
; GFX1010-NEXT:    s_and_b32 s0, s2, exec_lo
; GFX1010-NEXT:    s_cselect_b32 s0, 1, 0
; GFX1010-NEXT:    v_mov_b32_e32 v1, s1
; GFX1010-NEXT:    v_mov_b32_e32 v3, s0
...
; GFX1030W32-NEXT:    s_and_b32 s4, s6, exec_lo
; GFX1030W32-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1030W32-NEXT:    v_mov_b32_e32 v1, s5
; GFX1030W32-NEXT:    v_mov_b32_e32 v3, s4
; GFX1030W32-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
...
; GFX1030W64-NEXT:    v_mov_b32_e32 v3, s4
; GFX1030W64-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
...
; GFX13-NEXT:    s_and_b32 s4, s6, exec_lo
; GFX13-NEXT:    s_cselect_b32 s4, 1, 0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v3, s4
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1010-NEXT:    v_mov_b32_e32 v1, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_sub_co_u32 v0, s4, s6, s7
; GFX1010-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX1010-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1010-NEXT:    v_mov_b32_e32 v2, s4
; GFX1010-NEXT:    global_store_dword v1, v0, s[0:1]
...
; GFX1030W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030W32-NEXT:    v_sub_co_u32 v0, s4, s6, s7
; GFX1030W32-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX1030W32-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1030W32-NEXT:    v_mov_b32_e32 v2, s4
; GFX1030W32-NEXT:    global_store_dword v1, v0, s[0:1]
...
; GFX1030W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030W64-NEXT:    v_sub_co_u32 v0, s[4:5], s6, s7
; GFX1030W64-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX1030W64-NEXT:    s_cselect_b32 s4, 1, 0
; GFX1030W64-NEXT:    v_mov_b32_e32 v2, s4
; GFX1030W64-NEXT:    global_store_dword v1, v0, s[0:1]
...
; GFX13-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_sub_co_u32 v0, s4, s6, s7
; GFX13-NEXT:    s_and_b32 s4, s4, exec_lo
; GFX13-NEXT:    s_cselect_b32 s4, 1, 0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, s4
...
; GFX9-NEXT:    s_subb_u32 s2, s13, s15
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX9-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
...
; CISI-NEXT:    v_mul_lo_u32 v3, s0, v1
; CISI-NEXT:    v_mul_hi_u32 v4, s0, v0
; CISI-NEXT:    v_mul_lo_u32 v6, s1, v0
; CISI-NEXT:    v_mul_lo_u32 v2, s0, v0
; CISI-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CISI-NEXT:    v_add_i32_e32 v3, vcc, v6, v3
; CISI-NEXT:    v_mul_lo_u32 v4, v0, v3
; CISI-NEXT:    v_mul_hi_u32 v6, v0, v2
; CISI-NEXT:    v_mul_hi_u32 v7, v0, v3
; CISI-NEXT:    v_mul_hi_u32 v5, v1, v2
; CISI-NEXT:    v_mul_lo_u32 v2, v1, v2
; CISI-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CISI-NEXT:    v_addc_u32_e32 v6, vcc, 0, v7, vcc
; CISI-NEXT:    v_mul_hi_u32 v7, v1, v3
; CISI-NEXT:    v_mul_lo_u32 v3, v1, v3
; CISI-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
; CISI-NEXT:    v_addc_u32_e32 v2, vcc, v6, v5, vcc
; CISI-NEXT:    v_addc_u32_e32 v4, vcc, 0, v7, vcc
; CISI-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CISI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; CISI-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
...
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    v_add_u32_e32 v5, vcc, v8, v0
; VI-NEXT:    v_addc_u32_e32 v6, vcc, v7, v1, vcc
...
; VI-NEXT:    v_add_u32_e32 v7, vcc, v3, v1
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], v5, v7, 0
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v6, v0, 0
; VI-NEXT:    v_add_u32_e32 v8, vcc, v8, v1
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v6, v7, 0
...
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    v_add_u32_e32 v2, vcc, v5, v0
; VI-NEXT:    v_addc_u32_e32 v3, vcc, v6, v1, vcc
...
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], s3, v2, 0
; VI-NEXT:    v_readfirstlane_b32 s6, v4
; VI-NEXT:    s_add_u32 s9, s6, s9
; VI-NEXT:    s_addc_u32 s8, 0, s8
; VI-NEXT:    v_readfirstlane_b32 s10, v1
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], s3, v3, 0
; VI-NEXT:    v_readfirstlane_b32 s6, v0
; VI-NEXT:    s_add_u32 s6, s9, s6
; VI-NEXT:    s_addc_u32 s6, s8, s10
; VI-NEXT:    v_readfirstlane_b32 s7, v2
; VI-NEXT:    s_addc_u32 s8, s7, 0
...
; GFX9-NEXT:    s_mul_i32 s12, s8, s11
; GFX9-NEXT:    s_mul_i32 s15, s8, s10
; GFX9-NEXT:    s_mul_hi_u32 s8, s8, s11
; GFX9-NEXT:    s_add_i32 s8, s8, s15
...
; GFX9-NEXT:    s_add_u32 s8, s11, s8
; GFX9-NEXT:    s_addc_u32 s8, s10, s12
; GFX9-NEXT:    s_mul_hi_u32 s10, s3, s9
...
; GFX1010-NEXT:    s_mul_hi_u32 s12, s9, s5
; GFX1010-NEXT:    s_mul_i32 s9, s9, s4
; GFX1010-NEXT:    s_mul_i32 s10, s10, s5
; GFX1010-NEXT:    s_add_i32 s9, s12, s9
; GFX1010-NEXT:    s_mul_hi_u32 s13, s4, s11
; GFX1010-NEXT:    s_add_i32 s9, s9, s10
; GFX1010-NEXT:    s_mul_hi_u32 s10, s5, s11
; GFX1010-NEXT:    s_mul_i32 s14, s5, s9
; GFX1010-NEXT:    s_mul_i32 s12, s4, s11
; GFX1010-NEXT:    s_mul_hi_u32 s11, s5, s9
; GFX1010-NEXT:    s_add_u32 s10, s10, s14
; GFX1010-NEXT:    s_addc_u32 s11, 0, s11
; GFX1010-NEXT:    s_mul_hi_u32 s15, s4, s9
; GFX1010-NEXT:    s_add_u32 s10, s10, s12
; GFX1010-NEXT:    s_mul_i32 s9, s4, s9
; GFX1010-NEXT:    s_addc_u32 s10, s11, s13
; GFX1010-NEXT:    s_addc_u32 s11, s15, 0
...
; GFX1030W32-NEXT:    s_mul_hi_u32 s12, s9, s7
; GFX1030W32-NEXT:    s_mul_i32 s9, s9, s6
; GFX1030W32-NEXT:    s_mul_i32 s10, s10, s7
; GFX1030W32-NEXT:    s_add_i32 s9, s12, s9
; GFX1030W32-NEXT:    s_mul_hi_u32 s13, s6, s11
; GFX1030W32-NEXT:    s_add_i32 s9, s9, s10
; GFX1030W32-NEXT:    s_mul_hi_u32 s10, s7, s11
; GFX1030W32-NEXT:    s_mul_i32 s14, s7, s9
; GFX1030W32-NEXT:    s_mul_i32 s12, s6, s11
; GFX1030W32-NEXT:    s_mul_hi_u32 s11, s7, s9
; GFX1030W32-NEXT:    s_add_u32 s10, s10, s14
; GFX1030W32-NEXT:    s_addc_u32 s11, 0, s11
; GFX1030W32-NEXT:    s_mul_hi_u32 s15, s6, s9
; GFX1030W32-NEXT:    s_add_u32 s10, s10, s12
; GFX1030W32-NEXT:    s_mul_i32 s9, s6, s9
; GFX1030W32-NEXT:    s_addc_u32 s10, s11, s13
; GFX1030W32-NEXT:    s_addc_u32 s11, s15, 0
...
; GFX1030W64-NEXT:    s_mul_i32 s10, s8, s7
; GFX1030W64-NEXT:    s_mul_hi_u32 s11, s8, s7
; GFX1030W64-NEXT:    s_mul_i32 s8, s8, s6
; GFX1030W64-NEXT:    s_mul_i32 s9, s9, s7
; GFX1030W64-NEXT:    s_add_i32 s8, s11, s8
; GFX1030W64-NEXT:    s_mul_hi_u32 s12, s6, s10
; GFX1030W64-NEXT:    s_add_i32 s8, s8, s9
; GFX1030W64-NEXT:    s_mul_hi_u32 s9, s7, s10
; GFX1030W64-NEXT:    s_mul_i32 s13, s7, s8
; GFX1030W64-NEXT:    s_mul_i32 s11, s6, s10
; GFX1030W64-NEXT:    s_mul_hi_u32 s10, s7, s8
; GFX1030W64-NEXT:    s_add_u32 s9, s9, s13
; GFX1030W64-NEXT:    s_addc_u32 s10, 0, s10
; GFX1030W64-NEXT:    s_mul_hi_u32 s14, s6, s8
; GFX1030W64-NEXT:    s_add_u32 s9, s9, s11
; GFX1030W64-NEXT:    s_mul_i32 s8, s6, s8
; GFX1030W64-NEXT:    s_addc_u32 s9, s10, s12
; GFX1030W64-NEXT:    s_addc_u32 s10, s14, 0
...
; GFX1030W64-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX11-NEXT:    s_mul_hi_u32 s12, s9, s7
; GFX11-NEXT:    s_mul_i32 s9, s9, s6
; GFX11-NEXT:    s_mul_i32 s10, s10, s7
; GFX11-NEXT:    s_add_i32 s9, s12, s9
; GFX11-NEXT:    s_mul_hi_u32 s13, s6, s11
; GFX11-NEXT:    s_add_i32 s9, s9, s10
; GFX11-NEXT:    s_mul_hi_u32 s10, s7, s11
; GFX11-NEXT:    s_mul_i32 s14, s7, s9
; GFX11-NEXT:    s_mul_i32 s12, s6, s11
; GFX11-NEXT:    s_mul_hi_u32 s11, s7, s9
; GFX11-NEXT:    s_add_u32 s10, s10, s14
; GFX11-NEXT:    s_addc_u32 s11, 0, s11
; GFX11-NEXT:    s_mul_hi_u32 s15, s6, s9
; GFX11-NEXT:    s_add_u32 s10, s10, s12
; GFX11-NEXT:    s_mul_i32 s9, s6, s9
; GFX11-NEXT:    s_addc_u32 s10, s11, s13
; GFX11-NEXT:    s_addc_u32 s11, s15, 0
...
; GCN-ISEL-NEXT:   [[PHI1:%[0-9]+]]:sreg_64 = PHI [[S_MOV_B64_]], %bb.0, %35, %bb.3
; GCN-ISEL-NEXT:   $scc = COPY [[PHI1]]
; GCN-ISEL-NEXT:   [[S_CSELECT_B32_:%[0-9]+]]:sreg_32 = S_CSELECT_B32 1, 0, implicit $scc
; GCN-ISEL-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 1
; GCN-ISEL-NEXT:   S_CMP_LG_U32 killed [[S_CSELECT_B32_]], killed [[S_MOV_B32_1]], implicit-def $scc
...
; GCN-ISEL-NEXT:   [[S_SUB_I32_:%[0-9]+]]:sreg_32 = S_SUB_I32 killed [[S_MOV_B32_2]], [[COPY11]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_ADD_I32_1:%[0-9]+]]:sreg_32 = S_ADD_I32 [[COPY17]], [[S_MOV_B32_3]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_CSELECT_B32_1:%[0-9]+]]:sreg_32 = S_CSELECT_B32 killed [[S_SUB_I32_2]], [[S_SUB_I32_1]], implicit $scc
; GCN-ISEL-NEXT:   [[COPY19:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_1]]
; GCN-ISEL-NEXT:   [[S_CSELECT_B32_2:%[0-9]+]]:sreg_32 = S_CSELECT_B32 killed [[S_ADD_I32_1]], [[COPY19]], implicit $scc
; GCN-ISEL-NEXT:   [[S_ADD_I32_2:%[0-9]+]]:sreg_32 = S_ADD_I32 [[S_CSELECT_B32_2]], [[S_MOV_B32_3]], implicit-def dead $scc
; GCN-ISEL-NEXT:   S_CMP_GE_U32 killed [[S_CSELECT_B32_1]], [[COPY11]], implicit-def $scc
; GCN-ISEL-NEXT:   [[S_CSELECT_B32_3:%[0-9]+]]:sreg_32 = S_CSELECT_B32 killed [[S_ADD_I32_2]], [[S_CSELECT_B32_2]], implicit $scc
; GCN-ISEL-NEXT:   [[S_MOV_B32_4:%[0-9]+]]:sreg_32 = S_MOV_B32 0
; GCN-ISEL-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[S_CSELECT_B32_3]], %subreg.sub0, killed [[S_MOV_B32_4]], %subreg.sub1
...
; GCN-ISEL-NEXT: {{  $}}
; GCN-ISEL-NEXT:   [[COPY21:%[0-9]+]]:sreg_32 = COPY [[COPY9]].sub0
; GCN-ISEL-NEXT:   [[V_CVT_F32_U32_e64_:%[0-9]+]]:vgpr_32 = V_CVT_F32_U32_e64 [[COPY21]], 0, 0, implicit $mode, implicit $exec
...
; GCN-ISEL-NEXT:   [[V_MAC_F32_e64_:%[0-9]+]]:vgpr_32 = V_MAC_F32_e64 0, killed [[V_CVT_F32_U32_e64_1]], 0, killed [[S_MOV_B32_5]], 0, [[V_CVT_F32_U32_e64_]], 0, 0, implicit $mode, implicit $exec
...
; GCN-ISEL-NEXT:   [[V_MAC_F32_e64_1:%[0-9]+]]:vgpr_32 = V_MAC_F32_e64 0, [[V_TRUNC_F32_e64_]], 0, killed [[S_MOV_B32_8]], 0, [[V_MUL_F32_e64_]], 0, 0, implicit $mode, implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY25:%[0-9]+]]:sreg_32 = COPY [[S_SUB_U]].sub0
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_2:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY25]], [[V_CVT_U32_F32_e64_]], implicit $exec
...
; GCN-ISEL-NEXT:   [[S_ADD_C2:%[0-9]+]]:sreg_32, [[S_ADD_C3:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY35]], [[S_MOV_B32_10]], killed [[S_ADD_C1]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE9:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY37]], %subreg.sub0, [[S_MOV_B32_10]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE12:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[V_MUL_HI_U32_e64_10]], %subreg.sub0, [[S_MOV_B32_9]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE14:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY51]], %subreg.sub0, [[S_MOV_B32_10]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[S_ADD_C8:%[0-9]+]]:sreg_32, [[S_ADD_C9:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY53]], [[S_MOV_B32_10]], killed [[S_ADD_C7]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_ADD_C14:%[0-9]+]]:sreg_32, [[S_ADD_C15:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY66]], [[S_MOV_B32_10]], killed [[S_ADD_C13]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE21:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY67]], %subreg.sub0, [[S_MOV_B32_10]], %subreg.sub1
