...
; LSE-NEXT:    cinc x10, x11, hs
; LSE-NEXT:    // kill: def $x2 killed $x2 def $x2_x3
; LSE-NEXT:    mov x3, x10
; LSE-NEXT:    caspal x0, x1, x2, x3, [x9]
; LSE-NEXT:    mov x10, x0
; LSE-NEXT:    str x10, [sp, #8] // 8-byte Folded Spill
; LSE-NEXT:    mov x9, x1
; LSE-NEXT:    str x9, [sp, #16] // 8-byte Folded Spill
; LSE-NEXT:    subs x11, x9, x11
; LSE-NEXT:    ccmp x10, x8, #0, eq
; LSE-NEXT:    mov w8, wzr
; LSE-NEXT:    cinc w8, w8, ne
...
; LSE-NEXT:    mov x10, #-1 // =0xffffffffffffffff
; LSE-NEXT:    // kill: def $x2 killed $x2 def $x2_x3
; LSE-NEXT:    mov x3, x10
; LSE-NEXT:    caspal x0, x1, x2, x3, [x9]
; LSE-NEXT:    mov x10, x0
