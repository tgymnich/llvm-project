...
class GISelValueTracking : public GISelChangeObserver {
  ...
  fcmpImpliesClass(CmpInst::Predicate Pred, const MachineFunction &MF, Register LHS,
                   Register RHS, bool LookThroughSrc = true);
  std::tuple<Register, FPClassTest, FPClassTest>
...
public:
  ...
  KnownFPClass computeKnownFPClass(Register R, FPClassTest InterestedClasses = fcAllFlags,
                                   unsigned Depth = 0);
