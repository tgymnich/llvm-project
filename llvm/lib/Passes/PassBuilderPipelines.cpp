...
PassBuilder::buildLTODefaultPipeline(OptimizationLevel Level,
  ...
  MPM.addPass(OpenMPOptPass(ThinOrFullLTOPhase::FullLTOPostLink, /*SplitKernels=*/false));
  ...
  // 
  MPM.addPass(OpenMPOptPass(ThinOrFullLTOPhase::FullLTOPostLink, /*SplitKernels=*/true));
