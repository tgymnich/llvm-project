...
; RUN:   --emit-ir=vopd_f64_rounding 2>&1 \
; RUN:   | %FileCheck %s --check-prefix=ROUNDING
; ROUNDING: unsupported-floating-point-mode: v_dual_add_f64 [VOPD]
; ROUNDING-SAME: f64 rounding mode 1 is unsupported
...
; CHECK: ret void
	...
	.globl	vopd_f64_rounding
	.p2align	8
	.type	vopd_f64_rounding,@function
vopd_f64_rounding:
	v_dual_add_f64 v[0:1], v[2:3], v[4:5] :: v_dual_mov_b32 v3, 0
	s_endpgm
...
amdhsa.kernels:
  ...
  - .args: []
    ...
    .kernarg_segment_size: 0
    .max_flat_workgroup_size: 1024
    .name:           vopd_f64_rounding
    .private_segment_fixed_size: 0
    .sgpr_count:     1
    .symbol:         vopd_f64_rounding.kd
    .vgpr_count:     6
    .wavefront_size: 32
