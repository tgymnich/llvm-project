# Transpiler failure reducer

`utils/transpiler/reduce.py` turns a failing transpiler corpus bundle into a
...
```console
python3 utils/transpiler/reduce.py \
...
```json
{
  "format": "comgr-transpiler-reducer-bundle",
  "version": 1,
  "code_objects": [
