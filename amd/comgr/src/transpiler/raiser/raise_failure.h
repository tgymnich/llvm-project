...
#ifndef TRANSPILER_RAISE_FAILURE_H
#define TRANSPILER_RAISE_FAILURE_H
...
enum class RaiseFailureReason : uint16_t {
  ...
  // structured failure to explain it. A Transpiler bug, not a source-kernel
  // property.
  InternalError,
  ...
  // Strict-mode refusal: a lowering that would otherwise warn and continue is
  // rejected as potentially miscompiling.
