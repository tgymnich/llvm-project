...
#ifndef TRANSPILER_USER_SGPR_LAYOUT_H
#define TRANSPILER_USER_SGPR_LAYOUT_H
...
struct UserSgprLayout {
  ...
  // Stream a one-line debug summary useful for debug output and failure
