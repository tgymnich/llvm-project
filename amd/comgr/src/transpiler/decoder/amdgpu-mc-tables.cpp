//===- amdgpu-mc-tables.cpp - Transpiler ----------------------------------===//
//
...
VOPDComponentInfo::VOPDComponentInfo(const llvm::MCInstrDesc &Desc, bool VOPD3)
  ...
  int BitOp3OperandIdx = COMGR::transpiler::getNamedOperandIdx(
...
vgprLoweringOperandTables(const llvm::MCInstrDesc &Desc) {
  ...
  if (COMGR::transpiler::getNamedOperandIdx(Desc.getOpcode(), OpName::src0X) >=
      0) {
