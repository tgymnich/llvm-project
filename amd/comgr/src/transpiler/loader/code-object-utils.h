...
//===----------------------------------------------------------------------===//
//
// Extracts the AMDGPU-specific metadata the transpiler raiser needs from an ELF
...
#ifndef TRANSPILER_CODE_OBJECT_UTILS_H
#define TRANSPILER_CODE_OBJECT_UTILS_H
...
public:
  ...
  /// Resolved metadata for `KernelName`, or a `TranspilerError` when the code
