...
CONSTATTR float4
MATH_PRIVATE(epsincosredep)(float2 a)
{
    float2 a2 = sqr(a);
    float2 a3 = mul(a2, a);
    float2 a4 = sqr(a2);
    ...
    float pc = PE2(t, -0x1.27e4fcp-22f, 0x1.a01a02p-16f, -0x1.6c16c2p-10f);
    float2 c = add(fsub(1.0f, ldx(a2, -1)), mul(a4, add(C0, mul(a2, pc))));

    const float2 S0 = (float2)(0x1.555556p-28f, -0x1.555556p-3f);
    float ps = PE2(t, 0x1.71de3ap-19f, -0x1.a01a02p-13f, 0x1.111112p-7f);
